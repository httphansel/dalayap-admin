                ...
                <div class="container">
                    <div class="card p-3">
                        ...
                        <table class="table table-light table-hover" id="myTable">
                            ...
                            <?php
                            $residentQuery = "SELECT * FROM resident_data WHERE archive_data = 'Yes'";
                                    ...
                                    <tbody class="pt-3 fw-bold">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-outline-secondary" type="button" data-bs-toggle="modal" data-bs-target="#restoreModal<?= $resident['id'] ?>">
                                                    <i class="fa-solid fa-trash-can-arrow-up"></i>
                                                </button>

                                                <!-- modal for deleting -->
                                                <div class="modal fade" id="restoreModal<?= $resident['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-body text-center">
                                                                <i class="fa-solid fa-trash-can-arrow-up" style="font-size: 35px; color: green;"></i>
                                                                <p class="h5 mt-3">Are you sure you want to restore this data?</p>
                                                                <div class="row mt-3 float-end me-4">
                                                                    <div class="col">
                                                                        <button class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                                        <a href="../code/restore_resident.php?id=<?= $resident['id'] ?>" class="btn btn-success">Restore</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
